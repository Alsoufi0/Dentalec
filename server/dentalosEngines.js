export const dentalosEngines = {
  ...
  visualLearning: {
    ...
    outputLimit: 1050,
    prompt:
      'Convert the topic into visual learning structures. Include flowcharts, decision trees, diagnostic pathways, treatment pathways, comparison tables, memory maps, and clinical algorithms using Markdown tables and ASCII arrows.'
  },
  memoryPlan: {
    label: 'Memory Engine',
    mode: 'memoryPlan',
